...
- Changed Memory configuration:
  ...
  - Moved @datawarp/mastra-vector-libsql into @datawarp/mastra-core/vector/libsql (#16e5b04)
...
- Updated model configuration to use new language model interface from @datawarp/mastra-core (#8b416d9)
...
- Updated @datawarp/mastra-core to v0.2.0-alpha.94
...
- Upgraded to @datawarp/mastra-core v0.2.0-alpha.94
...
- Multiple core module updates integrated through @datawarp/mastra-core version bumps to 0.2.0-alpha.94
...
- Updated @datawarp/mastra-core to version 0.2.0-alpha.94
...
- Bumped version from 0.0.1-alpha.8 to 0.1.0-alpha.19, reflecting breaking changes
- Updated @datawarp/mastra-core dependency to use workspace versioning
...
- Updated all package dependencies to latest versions (#9c10484)
- Upgraded to @datawarp/mastra-core v0.2.0-alpha.94 with latest features and improvements
...
For detailed information about the @datawarp/mastra-core updates included in this release, please refer to the core module's changelog.
...
Note: Several minor version bumps and dependency updates were made to maintain compatibility with @datawarp/mastra-core updates.

For detailed API documentation, please visit our [Speechify Integration Guide](https://docs.mastra.ai/speech/speechify).

## stores/pg

Here's the structured changelog for @datawarp/mastra-pg for the week of February 2-9, 2025:

## @datawarp/mastra-pg - Combined PostgreSQL Package

### New Features

- Combined PostgreSQL vector and storage capabilities into a unified `@datawarp/mastra-pg` package (#c87eb4e)
...
Here's the structured changelog for @datawarp/mastra-astra for the week of February 2-9, 2025:

## @datawarp/mastra-astra Changelog (Feb 2-9, 2025)
...
- Moved package from `@datawarp/mastra-vector-astra` to `@datawarp/mastra-astra` for better organization (#c87eb4e)
...
Users upgrading from @datawarp/mastra-vector-astra should:
...
Here's the structured changelog for @datawarp/mastra-chroma for the week of February 2-9, 2025:

# @datawarp/mastra-chroma Changelog

## Package Migration

- Moved package from `@datawarp/mastra-vector-chroma` to `@datawarp/mastra-chroma` for better organization (#684d5d1)
...
- Included migration guide from @datawarp/mastra-vector-chroma
...
Here's the structured changelog for @datawarp/mastra-pinecone for the week of February 2-9, 2025:

## @datawarp/mastra-pinecone Changelog
...
- Moved package from `@datawarp/mastra-vector-pinecone` to `@datawarp/mastra-pinecone` for better organization (#c87eb4e)
...
- Updated migration guide for users moving from @datawarp/mastra-vector-pinecone (#c87eb4e)
...
Here's the structured changelog for @datawarp/mastra-qdrant for the week of February 2-9, 2025:

# @datawarp/mastra-qdrant Changelog
...
- Moved package from `@datawarp/mastra-vector-qdrant` to `@datawarp/mastra-qdrant` with improved organization (#c87eb4e)
...
- Included migration guide from `@datawarp/mastra-vector-qdrant` (#c87eb4e)
...
## @datawarp/mastra-upstash Updates
...
1. Replace `@datawarp/mastra-vector-upstash` and `@datawarp/mastra-store-upstash` with `@datawarp/mastra-upstash`
2. Update imports:

   ```typescript
   // Old
   import { UpstashVector } from '@datawarp/mastra-vector-upstash';
   import { UpstashStore } from '@datawarp/mastra-store-upstash';

   // New
   import { UpstashVector, UpstashStore } from '@datawarp/mastra-upstash';
   ```
...
Here's the structured changelog for @datawarp/mastra-vectorize for the week of February 2-9, 2025:

## @datawarp/mastra-vectorize 0.1.0-alpha.30

### Breaking Changes

- Renamed package from `@datawarp/mastra-vector-vectorize` to `@datawarp/mastra-vectorize` for better consistency (#91c81f5)
