...
Here's the changelog for @actus-ag/create-@mastra covering February 2-9, 2025:

## @actus-ag/create-@mastra Updates (0.1.0-alpha.33)
...
- Released new @actus-ag/create-@mastra version with improved stability (#9c10484)
...
- Made project name parameter optional with '@actus-ag/@mastra' as default (#4d4f6b6)
