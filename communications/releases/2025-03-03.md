...
- Updated vector filter location from @datawarp/mastra-core/filter to @datawarp/mastra-core/vector/filter (#fd14a3f)
...
- Updated dependencies to latest @datawarp/mastra-core version (0.5.0-alpha.0)
...
## @datawarp/mastra-rag v0.1.8-alpha.0
...
- Updated @datawarp/mastra-core dependency to v0.5.0-alpha.0
...
- Updated to @datawarp/mastra-core@0.5.0-alpha.0 which includes several core improvements
...
- Updated core dependencies to latest versions:
  - @datawarp/mastra-core to v0.5.0-alpha.0
  - @datawarp/mastra-deployer to v0.1.8-alpha.0
...
- Updated @datawarp/mastra-core dependency to version 0.5.0-alpha.0
...
# @datawarp/mastra-speech-deepgram Changelog

## Important Notice

🚨 This package is now deprecated in favor of `@datawarp/mastra-voice-deepgram`. Users should migrate to the new package for continued support and additional features.
...
**Migration Note**: Users should transition to `@datawarp/mastra-voice-deepgram` which provides enhanced functionality including both Text-to-Speech and Speech-to-Text capabilities.

## speech/elevenlabs

Based on the git diff, here's the changelog for the speech/elevenlabs module covering February 24 - March 3, 2025:

# @datawarp/mastra-speech-elevenlabs Changelog

## Important Notice: Package Deprecation

This package has been deprecated in favor of `@datawarp/mastra-voice-elevenlabs`. Users should migrate to the new package for continued support and updates.
...
For users of this package, please follow the migration guide to transition to `@datawarp/mastra-voice-elevenlabs`. The new package provides identical functionality with an improved API structure that's more consistent with other voice packages in the ecosystem.

## speech/google

Here's the structured changelog for the speech/google module covering February 24 - March 3, 2025:

## @datawarp/mastra-speech-google Changelog

### Important Notice

- Package deprecated in favor of @datawarp/mastra-voice-google (#5e0f727)
...
- Added clear instructions for migrating to @datawarp/mastra-voice-google
...
The main focus of this update is to guide users toward migrating to the new @datawarp/mastra-voice-google package while maintaining basic functionality for existing users during the transition period.
...
## @datawarp/mastra-speech-murf Changelog

### Important Notice

- Package deprecated in favor of `@datawarp/mastra-voice-murf` - users should migrate to the new package for continued support and updates (PR #5b1af96)
...
The focus for this period has been on providing a smooth deprecation path for users to migrate to the new `@datawarp/mastra-voice-murf` package. All users should begin planning their migration as this package will no longer receive feature updates.

## speech/openai

Here's the structured changelog for @datawarp/mastra-speech-openai for the period of Feb 24 - Mar 3, 2025:

# @datawarp/mastra-speech-openai Changelog

## Important Notice

🚨 This package is now deprecated in favor of [@datawarp/mastra-voice-openai](https://github.com/mastra-ai/mastra/tree/main/voice/openai).

## Major Changes

- Deprecated @datawarp/mastra-speech-openai package - users should migrate to @datawarp/mastra-voice-openai for enhanced Text-to-Speech and Speech-to-Text capabilities (#0821d6b)
...
- Updated README with deprecation notice and migration guide
- Added clear instructions for transitioning to @datawarp/mastra-voice-openai
- Removed outdated API documentation

## Dependencies

- Updated core dependency to @datawarp/mastra-core@0.5.0-alpha.0
- Added @internal/lint as development dependency
- Removed unnecessary test dependencies (vitest)

Users are strongly encouraged to migrate to @datawarp/mastra-voice-openai for continued support and new features. The new package provides an enhanced API with both Text-to-Speech and Speech-to-Text capabilities.

## speech/playai

Here's the structured changelog for the speech/playai module covering February 24 - March 3, 2025:

# @datawarp/mastra-speech-playai Changelog

## Important Notice: Package Deprecation

This package has been deprecated in favor of `@datawarp/mastra-voice-playai`. Users should migrate to the new package for continued support and updates.

### Migration Guide

- Added comprehensive migration documentation to help users transition to `@datawarp/mastra-voice-playai` (#41d0166)
...
For users of this package, please refer to the migration guide in the README for detailed instructions on upgrading to `@datawarp/mastra-voice-playai`.
...
# @datawarp/mastra-speech-speechify Changelog

## Important Notice: Package Deprecation

This package has been deprecated in favor of `@datawarp/mastra-voice-speechify`. Users should migrate to the new package for continued support and updates.

### Migration Guide

- Added comprehensive migration documentation to help users transition to `@datawarp/mastra-voice-speechify` (#f477df7)
...
The focus for this release has been on providing a smooth deprecation path and ensuring users can easily migrate to the new `@datawarp/mastra-voice-speechify` package. No new features were added as the package is now in maintenance mode.
...
- Updated filter location from @datawarp/mastra-core/filter to @datawarp/mastra-core/vector/filter (#fd14a3f)
...
- Improved filter handling with new `VectorFilter` type from `@datawarp/mastra-core` (#fd14a3f)
...
- Updated `@datawarp/mastra-core` to version 0.5.0-alpha.0
...
- Moved filter functionality from `@datawarp/mastra-core/filter` to `@datawarp/mastra-core/vector/filter` for better organization (#fd14a3f)
...
- Updated filter handling to use the new `VectorFilter` type from `@datawarp/mastra-core` for better type safety
...
- Updated to `@datawarp/mastra-core@0.5.0-alpha.0`
...
- Updated filter location from `@datawarp/mastra-core/filter` to `@datawarp/mastra-core/vector/filter` for better organization (#fd14a3f)
...
- Updated dependencies to latest @datawarp/mastra-core version
