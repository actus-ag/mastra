...
- Fixed @actus-ag/@mastra/cli/cli dev backslash issues (#9c1057d)
...
Here's the structured changelog for @actus-ag/create-@mastra covering the period from February 24 to March 3, 2025:

## @actus-ag/create-@mastra Updates
...
- Improved version tag discovery mechanism for @actus-ag/create-@mastra (#5c7b8db)
- Removed CLI postinstall script (#13ba53a)
- Enhanced version tag handling for @actus-ag/create-@mastra dependencies (#dd3a52b)
