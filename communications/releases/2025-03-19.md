...
- Updated @datawarp/mastra-core dependency to version 0.6.3
...
- Updated @datawarp/mastra-deployer to version 0.2.3
- Updated @datawarp/mastra-core to version 0.6.3
...
- Updated dependency on @datawarp/mastra-core to version 0.6.3
...
This module is deprecated - please use `@datawarp/mastra-voice-deepgram` instead.
...
- Updated to @datawarp/mastra-core@0.6.3 which includes several core system improvements

Note: Most changes in this release period were internal dependency updates and version alignments. No major functional changes were introduced to this deprecated module as development focus has shifted to the new `@datawarp/mastra-voice-deepgram` package.
...
For users of this module, we strongly recommend migrating to `@datawarp/mastra-voice-elevenlabs` as this package will no longer receive feature updates.
...
This module is deprecated - please use `@datawarp/mastra-voice-google` instead.
...
- Updated to @datawarp/mastra-core@0.6.3 which includes:
...
This module (@datawarp/mastra-speech-murf) is now deprecated. Please migrate to @datawarp/mastra-voice-murf for future development.
...
This module is deprecated - please migrate to `@datawarp/mastra-voice-openai` for future updates.
...
Note: This update primarily focuses on internal improvements and dependency updates. The module is now in maintenance mode as it has been deprecated in favor of @datawarp/mastra-voice-openai.
...
- Updated to @datawarp/mastra-core@0.6.3 which includes several core improvements

## Additional Notes

This module is now deprecated - users should migrate to `@datawarp/mastra-voice-playai` for future updates and improvements.
...
- Updated dependency on @datawarp/mastra-core to version 0.6.3 (#404640e)

### Important Notice

This module (@datawarp/mastra-speech-speechify) is now deprecated. Please use @datawarp/mastra-voice-speechify instead.
...
Most changes in this period were dependency updates and internal adjustments to maintain compatibility with @datawarp/mastra-core updates. The main functional change was the addition of AgentNetwork support.
...
- Updated to @datawarp/mastra-core@0.6.3 which includes stability improvements
...
- Updated @datawarp/mastra-core dependency to version 0.6.3 for improved compatibility and stability
