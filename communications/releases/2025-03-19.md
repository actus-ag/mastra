...
- Added Cerebras and Google AI as LLM providers in @actus-ag/create-@mastra (#f9b6ab5)
...
- Deprecated `@actus-ag/@mastra/cli/cli dev --env` flag (#d3d6fae)
...
Here's the structured changelog for @actus-ag/create-@mastra (March 12-19, 2025):
...
- Deprecated the `--env` flag in `@actus-ag/@mastra/cli/cli dev` command (#d3d6fae)
