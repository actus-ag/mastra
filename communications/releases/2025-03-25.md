...
- Updated dependencies:
  - ESLint to v9.23.0
  - Vitest to v3.0.9
  - @actus-ag/mastra-core to v0.7.0-alpha.1
...
- Updated core Mastra dependencies to latest versions:
  - @actus-ag/mastra-deployer to v0.2.5-alpha.1
  - @actus-ag/mastra-core to v0.7.0-alpha.1
...
- Updated core dependencies to align with @actus-ag/mastra-core v0.7.0-alpha.1
...
This module is now deprecated. Please use `@actus-ag/mastra-voice-deepgram` for new implementations.
...
This module is now deprecated. Please migrate to `@actus-ag/mastra-voice-elevenlabs` for future development and updates.
...
- Multiple compatibility updates to align with @actus-ag/mastra-core v0.7.0-alpha.1
...
- Updated Node.js type definitions to v20.17.27 for improved TypeScript support
- Upgraded ESLint to v9.23.0 for enhanced code quality checks
- Updated core dependency to @actus-ag/mastra-core@0.7.0-alpha.1
...
For a complete list of underlying core framework changes, please refer to the [@actus-ag/mastra-core changelog](link-to-core-changelog).
...
- Updated Node.js type definitions to version 20.17.27 for improved TypeScript support
- Upgraded ESLint to version 9.23.0 for enhanced code quality checks
- Updated core dependencies to align with @actus-ag/mastra-core@0.7.0-alpha.1

## Important Notice

This module is now deprecated. Please migrate to `@actus-ag/mastra-voice-murf` for future development.
...
- If you're starting a new project, use `@actus-ag/mastra-voice-murf` instead
...
This module is now deprecated. Please migrate to `@actus-ag/mastra-voice-openai` for future development and updates.
...
- Plan migration to `@actus-ag/mastra-voice-openai` for future development
...
This module is now deprecated - users should migrate to `@actus-ag/mastra-voice-playai` for future development.
...
- Continue using `@actus-ag/mastra-voice-playai` for new projects
...
- Updated core dependency to @actus-ag/mastra-core@0.7.0-alpha.1 for improved stability and feature support (#0b54522, #1af25d5, #27439ad)
- Upgraded development dependencies:
...
This module is now deprecated. Please use `@actus-ag/mastra-voice-speechify` instead for future development.
...
- We recommend migrating to `@actus-ag/mastra-voice-speechify` for continued support and new features
...
- Updated to @actus-ag/mastra-core@0.7.0-alpha.1 which includes several internal improvements
...
For more details about the core updates, please refer to the [@actus-ag/mastra-core changelog](link-to-core-changelog).
...
- Upgraded core dependency to @actus-ag/mastra-core@0.7.0-alpha.1
- Updated development dependencies:
  - Node.js types to v20.17.27
  - ESLint to v9.23.0
  - Vitest to v3.0.9
...
## @actus-ag/mastra-upstash v0.2.1-alpha.1
...
- Updated core dependencies to @actus-ag/mastra-core@0.7.0-alpha.1
- Upgraded development dependencies:
