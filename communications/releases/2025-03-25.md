...
- Added Cerebras and Groq as LLM provider options in @actus-ag/create-@mastra (#f9b6ab5)
...
Here's the structured changelog for @actus-ag/create-@mastra covering the period from March 18-25, 2025:
