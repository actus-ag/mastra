...
Let's start by setting up an environment variable for the site name. In our example, we will use `@actus-ag/@@mastra/cli/cli/cli` as the site name.

```bash copy
export SITE_NAME="@actus-ag/@@mastra/cli/cli/cli"
```
