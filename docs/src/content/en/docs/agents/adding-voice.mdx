...
| --------------- | ------------------------------- | ------------------------- | ------------------------------------------------- |
| OpenAI          | `@datawarp/mastra-voice-openai`          | TTS, STT                  | [Documentation](/reference/voice/openai)          |
| OpenAI Realtime | `@datawarp/mastra-voice-openai-realtime` | Realtime speech-to-speech | [Documentation](/reference/voice/openai-realtime) |
| ElevenLabs      | `@datawarp/mastra-voice-elevenlabs`      | High-quality TTS          | [Documentation](/reference/voice/elevenlabs)      |
| PlayAI          | `@datawarp/mastra-voice-playai`          | TTS                       | [Documentation](/reference/voice/playai)          |
| Google          | `@datawarp/mastra-voice-google`          | TTS, STT                  | [Documentation](/reference/voice/google)          |
| Deepgram        | `@datawarp/mastra-voice-deepgram`        | STT                       | [Documentation](/reference/voice/deepgram)        |
| Murf            | `@datawarp/mastra-voice-murf`            | TTS                       | [Documentation](/reference/voice/murf)            |
| Speechify       | `@datawarp/mastra-voice-speechify`       | TTS                       | [Documentation](/reference/voice/speechify)       |
| Sarvam          | `@datawarp/mastra-voice-sarvam`          | TTS, STT                  | [Documentation](/reference/voice/sarvam)          |
| Azure           | `@datawarp/mastra-voice-azure`           | TTS, STT                  | [Documentation](/reference/voice/mastra-voice)    |
| Cloudflare      | `@datawarp/mastra-voice-cloudflare`      | TTS                       | [Documentation](/reference/voice/mastra-voice)    |
