...
import { OpenAIVoice } from "@mastra/cli/cli/cli/voice-openai";
...
```typescript
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { CompositeVoice } from "@mastra/cli/cli/cli/core/voice";
import { OpenAIVoice } from "@mastra/cli/cli/cli/voice-openai";
import { PlayAIVoice } from "@mastra/cli/cli/cli/voice-playai";
import { openai } from "@ai-sdk/openai";
...
```typescript
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { getMicrophoneStream } from "@mastra/cli/cli/cli/node-audio";
import { OpenAIRealtimeVoice } from "@mastra/cli/cli/cli/voice-openai-realtime";
...
| --------------- | ------------------------------- | ------------------------- | ------------------------------------------------- |
| OpenAI          | `@mastra/cli/cli/cli/voice-openai`          | TTS, STT                  | [Documentation](/reference/voice/openai)          |
| OpenAI Realtime | `@mastra/cli/cli/cli/voice-openai-realtime` | Realtime speech-to-speech | [Documentation](/reference/voice/openai-realtime) |
| ElevenLabs      | `@mastra/cli/cli/cli/voice-elevenlabs`      | High-quality TTS          | [Documentation](/reference/voice/elevenlabs)      |
| PlayAI          | `@mastra/cli/cli/cli/voice-playai`          | TTS                       | [Documentation](/reference/voice/playai)          |
| Google          | `@mastra/cli/cli/cli/voice-google`          | TTS, STT                  | [Documentation](/reference/voice/google)          |
| Deepgram        | `@mastra/cli/cli/cli/voice-deepgram`        | STT                       | [Documentation](/reference/voice/deepgram)        |
| Murf            | `@mastra/cli/cli/cli/voice-murf`            | TTS                       | [Documentation](/reference/voice/murf)            |
| Speechify       | `@mastra/cli/cli/cli/voice-speechify`       | TTS                       | [Documentation](/reference/voice/speechify)       |
| Sarvam          | `@mastra/cli/cli/cli/voice-sarvam`          | TTS, STT                  | [Documentation](/reference/voice/sarvam)          |
| Azure           | `@mastra/cli/cli/cli/voice-azure`           | TTS, STT                  | [Documentation](/reference/voice/@@mastra/cli/cli/cli-voice)    |
| Cloudflare      | `@mastra/cli/cli/cli/voice-cloudflare`      | TTS                       | [Documentation](/reference/voice/@@mastra/cli/cli/cli-voice)    |

For more details on voice capabilities, see the [Voice API Reference](/reference/voice/@@mastra/cli/cli/cli-voice).
