...
| --------------- | ------------------------------- | ------------------------- | ------------------------------------------------- |
| OpenAI          | `@actus-ag/mastra-voice-openai`          | TTS, STT                  | [Documentation](/reference/voice/openai)          |
| OpenAI Realtime | `@actus-ag/mastra-voice-openai-realtime` | Realtime speech-to-speech | [Documentation](/reference/voice/openai-realtime) |
| ElevenLabs      | `@actus-ag/mastra-voice-elevenlabs`      | High-quality TTS          | [Documentation](/reference/voice/elevenlabs)      |
| PlayAI          | `@actus-ag/mastra-voice-playai`          | TTS                       | [Documentation](/reference/voice/playai)          |
| Google          | `@actus-ag/mastra-voice-google`          | TTS, STT                  | [Documentation](/reference/voice/google)          |
| Deepgram        | `@actus-ag/mastra-voice-deepgram`        | STT                       | [Documentation](/reference/voice/deepgram)        |
| Murf            | `@actus-ag/mastra-voice-murf`            | TTS                       | [Documentation](/reference/voice/murf)            |
| Speechify       | `@actus-ag/mastra-voice-speechify`       | TTS                       | [Documentation](/reference/voice/speechify)       |
| Sarvam          | `@actus-ag/mastra-voice-sarvam`          | TTS, STT                  | [Documentation](/reference/voice/sarvam)          |
| Azure           | `@actus-ag/mastra-voice-azure`           | TTS, STT                  | [Documentation](/reference/voice/mastra-voice)    |
| Cloudflare      | `@actus-ag/mastra-voice-cloudflare`      | TTS                       | [Documentation](/reference/voice/mastra-voice)    |
