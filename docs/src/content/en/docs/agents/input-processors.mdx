...
import { UnicodeNormalizer } from "@mastra/cli/cli/cli/core/processors";
...
import { ModerationProcessor } from "@mastra/cli/cli/cli/core/processors";
...
import { PromptInjectionDetector } from "@mastra/cli/cli/cli/core/processors";
...
import { PIIDetector } from "@mastra/cli/cli/cli/core/processors";
...
```typescript copy showLineNumbers {5-12}
import { LanguageDetector } from "@mastra/cli/cli/cli/core/processors";
...
import { 
  ...
  PromptInjectionDetector,
  PIIDetector 
} from "@mastra/cli/cli/cli/core/processors";
...
import type { Processor, MastraMessageV2, TripWire } from "@mastra/cli/cli/cli/core/processors";
