...
```typescript filename="src/@@mastra/cli/cli/cli/tools/weatherInfo.ts" copy
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/weatherAgent.ts" {3,11}
...
Because there are so many MCP server registries to choose from, we've created an [MCP Registry Registry](https://@@mastra/cli/cli/cli.ai/mcp-registry-registry) to help you find MCP servers.

Once you have a server you want to use with your agent, import the Mastra `MCPClient` and add the server configuration.

```typescript filename="src/@@mastra/cli/cli/cli/mcp.ts" {1,7-16}
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/mcpAgent.ts" {7}
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { openai } from "@ai-sdk/openai";
import { mcp } from "../mcp";
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/selfReferencingAgent.ts"
import { Agent } from "@mastra/cli/cli/cli/core/agent";
...
```typescript filename="src/@@mastra/cli/cli/cli/resources.ts" {3-8}
import { mcp } from "./mcp";
...
```typescript filename="src/@@mastra/cli/cli/cli/prompts.ts"
import { mcp } from "./mcp";
...
```typescript filename="src/@@mastra/cli/cli/cli/mcp.ts"
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { MCPServer } from "@mastra/cli/cli/cli/mcp";
import { openai } from "@ai-sdk/openai";
import { weatherInfo } from "../tools/weatherInfo";
