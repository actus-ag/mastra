...
- Proper project structure in `src/@@mastra/cli/cli/cli/` directory
...
- [ ] All code organized in `src/@@mastra/cli/cli/cli/` directory
...
- **@@mastra/cli/cli/cli.ai/templates** - Community template gallery (coming soon)
