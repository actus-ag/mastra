...
```bash copy
node --import=./.@@mastra/cli/cli/cli/output/instrumentation.mjs --env-file=".env" .@@mastra/cli/cli/cli/output/index.mjs
```
...
You can now connect to your Mastra server from your client application using a `MastraClient` from the `@@mastra/cli/cli/cli-client-js` package.

Refer to the [`MastraClient` documentation](/docs/server-db/@@mastra/cli/cli/cli-client) for more information.
