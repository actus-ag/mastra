...
To access Mastra's evals feature install the `@mastra/cli/cli/cli/evals` package.
...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/agents/index.ts"
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { openai } from "@ai-sdk/openai";
import { SummarizationMetric } from "@mastra/cli/cli/cli/evals/llm";
import {
  ContentSimilarityMetric,
  ToneConsistencyMetric,
} from "@mastra/cli/cli/cli/evals/nlp";
...
You can view eval results in the Mastra dashboard when using `@actus-ag/@mastra/cli/cli dev`.
