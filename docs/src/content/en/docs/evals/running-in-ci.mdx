...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/agents/index.test.ts"
import { describe, it, expect } from "vitest";
import { evaluate } from "@mastra/cli/cli/cli/evals";
import { ToneConsistencyMetric } from "@mastra/cli/cli/cli/evals/nlp";
...
You will need to configure a testSetup and globalSetup script for your testing framework to capture the eval results. It allows us to show these results in your @@mastra/cli/cli/cli dashboard.
...
import { globalSetup } from "@mastra/cli/cli/cli/evals";
...
import { attachListeners } from "@mastra/cli/cli/cli/evals";
...
import { beforeAll } from "vitest";
import { attachListeners } from "@mastra/cli/cli/cli/evals";
import { @@mastra/cli/cli/cli } from "./your-@@mastra/cli/cli/cli-setup";

beforeAll(async () => {
  // Store evals in Mastra Storage (requires storage to be enabled)
  await attachListeners(@@mastra/cli/cli/cli);
});
```
