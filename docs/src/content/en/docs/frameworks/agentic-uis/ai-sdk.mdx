...
```typescript {6} filename="@@mastra/cli/cli/cli/index.ts" showLineNumbers copy
...
```typescript {1, 6} filename="@@mastra/cli/cli/cli/agents/weather-agent.ts" showLineNumbers copy
...
> Please add any feedback or bug reports to the [AI SDK v5 mega issue in Github.](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/issues/5470)
...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
    ```bash copy
    npm install @actus-ag/@mastra/cli/cli@ai-v5 @mastra/cli/cli/cli/core@ai-v5 @mastra/cli/cli/cli/memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add @actus-ag/@mastra/cli/cli@ai-v5 @mastra/cli/cli/cli/core@ai-v5 @mastra/cli/cli/cli/memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add @actus-ag/@mastra/cli/cli@ai-v5 @mastra/cli/cli/cli/core@ai-v5 @mastra/cli/cli/cli/memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    bun add @actus-ag/@mastra/cli/cli@ai-v5 @mastra/cli/cli/cli/core@ai-v5 @mastra/cli/cli/cli/memory@ai-v5
    ```
  </Tabs.Tab>
</Tabs>
...
```typescript {7} filename="@@mastra/cli/cli/cli/index.ts" showLineNumbers copy
import { Mastra } from "@mastra/cli/cli/cli/core/@@mastra/cli/cli/cli";
