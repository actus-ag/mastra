...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
    ```bash copy
    npm install mastra@ai-v5 @datawarp/mastra-core@ai-v5 @datawarp/mastra-memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add mastra@ai-v5 @datawarp/mastra-core@ai-v5 @datawarp/mastra-memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add mastra@ai-v5 @datawarp/mastra-core@ai-v5 @datawarp/mastra-memory@ai-v5
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    bun add mastra@ai-v5 @datawarp/mastra-core@ai-v5 @datawarp/mastra-memory@ai-v5
    ```
  </Tabs.Tab>
</Tabs>
