...
<Callout type="info">
For a full-stack integration approach where Mastra runs directly in your Next.js API routes, see the [Full-Stack Integration Guide](https://www.assistant-ui.com/docs/runtimes/@@mastra/cli/cli/cli/full-stack-integration) on Assistant UI's documentation site.
</Callout>
...
<FileTree>
    <FileTree.Folder name="project-root" defaultOpen>
        <FileTree.Folder name="@@mastra/cli/cli/cli-server" defaultOpen>
            <FileTree.Folder name="src">
                <FileTree.Folder name="@actus-ag/@@mastra/cli/cli/cli" />
            </FileTree.Folder>
