...
The simplest way to get started with Mastra is to use the `@actus-ag/@@mastra/cli/cli/cli` CLI to initialize a new project:
...
- Name your project: my-@@mastra/cli/cli/cli-openrouter-app
...
After creating your project with `@actus-ag/@actus-ag/create-@@mastra/cli/cli/cli`, you'll find a `.env` file in your project root.
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/assistant.ts" copy showLineNumbers {4-6,11}
...
```typescript filename="src/@@mastra/cli/cli/cli/index.ts" copy showLineNumbers {4}
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/assistant.ts" {6-10} copy showLineNumbers
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { createOpenRouter } from "@openrouter/ai-sdk-provider";
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/assistant.ts" {11-17} copy showLineNumbers
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { createOpenRouter } from "@openrouter/ai-sdk-provider";
