...
```bash copy
npx @actus-ag/@mastra/cli/cli@latest init --dir . --components agents,tools --example --llm openai
```
...
<Callout type="warning">
By default, `@actus-ag/@mastra/cli/cli init` suggests `src` as the install location. If you're using the App Router at the root of your project (e.g., `app`, not `src/app`), enter `.` when prompted:
</Callout>
...
<Tabs items={["app", "src/app"]}>
  <Tabs.Tab>
    ```json filename="package.json"
    {
      "scripts": {
        ...
        "dev:@@mastra/cli/cli/cli": "@actus-ag/@mastra/cli/cli dev --dir @@mastra/cli/cli/cli",
        "build:@@mastra/cli/cli/cli": "@actus-ag/@mastra/cli/cli build --dir @@mastra/cli/cli/cli"
      }
    }
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```json filename="package.json"
    {
      "scripts": {
        ...
        "dev:@@mastra/cli/cli/cli": "@actus-ag/@mastra/cli/cli dev --dir src/@@mastra/cli/cli/cli",
        "build:@@mastra/cli/cli/cli": "@actus-ag/@mastra/cli/cli build --dir src/@@mastra/cli/cli/cli"
      }
    }
    ```
  </Tabs.Tab>
...
<Callout type="warning">
By default, `@actus-ag/@mastra/cli/cli init` suggests `src` as the install location. If you're using the Pages Router at the root of your project (e.g., `pages`, not `src/pages`), enter `.` when prompted:
</Callout>
...
> Once running, your agents are available locally. See [Local Development Environment](/docs/local-dev/@@mastra/cli/cli/cli-dev) for more information.
