...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
    ```bash copy
    npm install mastra@latest @datawarp/mastra-core@latest @datawarp/mastra-libsql@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add mastra@latest @datawarp/mastra-core@latest @datawarp/mastra-libsql@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add mastra@latest @datawarp/mastra-core@latest @datawarp/mastra-libsql@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    bun add mastra@latest @datawarp/mastra-core@latest @datawarp/mastra-libsql@latest
    ```
  </Tabs.Tab>
</Tabs>
