...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
    ```bash copy
    npm install @actus-ag/@mastra/cli/cli@latest @mastra/cli/cli/cli/core@latest @mastra/cli/cli/cli/libsql@latest @@mastra/cli/cli/cli-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add @actus-ag/@mastra/cli/cli@latest @mastra/cli/cli/cli/core@latest @mastra/cli/cli/cli/libsql@latest @@mastra/cli/cli/cli-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add @actus-ag/@mastra/cli/cli@latest @mastra/cli/cli/cli/core@latest @mastra/cli/cli/cli/libsql@latest @@mastra/cli/cli/cli-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    bun add @actus-ag/@mastra/cli/cli@latest @mastra/cli/cli/cli/core@latest @mastra/cli/cli/cli/libsql@latest @@mastra/cli/cli/cli-client-js@latest
    ```
  </Tabs.Tab>
</Tabs>
...
<Callout type="warning">
By default, `@actus-ag/@mastra/cli/cli init` suggests `src` as the install location. If you're using Vite/React at the root of your project (e.g., `app`, not `src/app`), enter `.` when prompted:
</Callout>
...
```bash copy
mkdir lib
touch lib/@@mastra/cli/cli/cli.ts
```

```typescript filename="lib/@@mastra/cli/cli/cli.ts" showLineNumbers copy
