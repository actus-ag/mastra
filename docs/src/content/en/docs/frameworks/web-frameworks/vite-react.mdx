...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>
    ```bash copy
    npm install mastra@latest @actus-ag/mastra-core@latest @actus-ag/mastra-libsql@latest @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add mastra@latest @actus-ag/mastra-core@latest @actus-ag/mastra-libsql@latest @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add mastra@latest @actus-ag/mastra-core@latest @actus-ag/mastra-libsql@latest @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    bun add mastra@latest @actus-ag/mastra-core@latest @actus-ag/mastra-libsql@latest @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
</Tabs>
