...
Initialize a TypeScript project including the `@actus-ag/mastra-core` package:
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab>
    ...
    npm install @actus-ag/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    pnpm add @actus-ag/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    yarn add @actus-ag/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    bun add @actus-ag/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
