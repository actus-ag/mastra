...
Initialize a TypeScript project including the `@datawarp/mastra-core` package:
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab>
    ...
    npm install @datawarp/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    pnpm add @datawarp/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    yarn add @datawarp/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
  ...
  <Tab>
    ...
    bun add @datawarp/mastra-core@latest zod@^3 @ai-sdk/openai
    ```
