...
```typescript showLineNumbers copy {1,7} filename="src/@@mastra/cli/cli/cli/agents/weather-agent.ts"
...
```typescript showLineNumbers copy filename="src/@@mastra/cli/cli/cli/agents/weather-agent.ts" {1,4-8,13}
...
```typescript showLineNumbers copy filename="src/@@mastra/cli/cli/cli/agents/weather-agent.ts" {1,4-14,19}
...
```typescript showLineNumbers copy filename="src/@@mastra/cli/cli/cli/agents/weather-agent.ts" {1,7}
...
```typescript showLineNumbers copy filename="src/@@mastra/cli/cli/cli/agents/weather-agent.ts" {1,4-7,12}
