...
Install a template using the `@actus-ag/@actus-ag/create-@@mastra/cli/cli/cli` command:
...
<Tabs items={["npx", "npm", "yarn", "pnpm", "bun"]}>
  ...
  <Tab>
    ```bash copy
    npm create @actus-ag/@mastra/cli/cli@latest --template template-name
    ```
  </Tab>
  <Tab>
    ```bash copy
    yarn create @actus-ag/@mastra/cli/cli@latest --template template-name
    ```
  </Tab>
  <Tab>
    ```bash copy
    pnpm create @actus-ag/@mastra/cli/cli@latest --template template-name
    ```
  </Tab>
  <Tab>
    ```bash copy
    bun create @actus-ag/@mastra/cli/cli@latest --template template-name
    ```
  </Tab>
</Tabs>
...
Browse available templates in the [templates directory](https://@@mastra/cli/cli/cli.ai/templates).
