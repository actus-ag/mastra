...
import { MastraCloudCallout } from '@/components/@@mastra/cli/cli/cli-cloud-callout'

# Navigating the Dashboard

This page explains how to navigate the Mastra Cloud dashboard, where you can configure your project, view deployment details, and interact with agents and workflows using the built-in [Playground](/docs/@@mastra/cli/cli/cli-cloud/dashboard#playground).
...
![Project dashboard](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-project-dashboard.jpg)
...
![Dashboard deployment](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-deployments.jpg)
...
![Dashboard logs](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-logs.jpg)
...
![Dashboard settings](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-settings.jpg)
...
![Dashboard playground agents](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-playground-agents.jpg)
...
![Dashboard playground workflows](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-playground-workflows.jpg)
...
![Dashboard playground tools](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-playground-tools.jpg)
...
![Dashboard playground mcp servers](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-dashboard-playground-mcpservers.jpg)
...
- [Understanding Tracing and Logs](/docs/@@mastra/cli/cli/cli-cloud/observability)
