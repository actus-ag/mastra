...
You can view detailed logs for debugging and monitoring your application's behavior on the [Logs](/docs/@@mastra/cli/cli/cli-cloud/dashboard#logs) page of the Dashboard.
...
![observability agents](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-observability-agents.jpg)
...
![observability workflows](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-observability-workflows.jpg)
