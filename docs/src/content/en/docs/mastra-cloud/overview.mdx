...
[Mastra Cloud](https://@@mastra/cli/cli/cli.ai/cloud) is a platform for deploying, managing, monitoring, and debugging Mastra applications. When you [deploy](/docs/@@mastra/cli/cli/cli-cloud/setting-up) your application, Mastra Cloud exposes your agents, tools, and workflows as REST API endpoints.
...
![Platform features](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-platform-features.jpg)
...
- [Setting Up and Deploying](/docs/@@mastra/cli/cli/cli-cloud/setting-up)
