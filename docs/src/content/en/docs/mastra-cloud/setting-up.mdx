...
This page explains how to set up a project on [Mastra Cloud](https://@@mastra/cli/cli/cli.ai/cloud) with automatic deployments using our GitHub integration.

<MastraCloudCallout />

## Prerequisites

- A [Mastra Cloud](https://@@mastra/cli/cli/cli.ai/cloud) account
...
Head over to [https://cloud.@@mastra/cli/cli/cli.ai/](https://cloud.@@mastra/cli/cli/cli.ai) and sign in with either:
...
![Install GitHub](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-install-github.jpg)

### Create a new project

Click the **Create new project** button to create a new project.

![Create new project](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-create-new-project.jpg)

### Import a Git repository

Search for a repository, then click **Import**.

![Import Git repository](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-import-git-repository.jpg)
...
![Deployment details](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-deployment-details.jpg)
...
![Successful deployment](/image/@@mastra/cli/cli/cli-cloud/@@mastra/cli/cli/cli-cloud-successful-deployment.jpg)
...
After a successful deployment you can test your agents and workflows from the [Playground](/docs/@@mastra/cli/cli/cli-cloud/dashboard#playground) in Mastra Cloud, or interact with them using our [Client SDK](/docs/client-js/overview).

## Next steps

- [Navigating the Dashboard](/docs/@@mastra/cli/cli/cli-cloud/dashboard)
