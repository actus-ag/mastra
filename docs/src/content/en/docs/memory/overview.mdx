...
```typescript filename="src/@@mastra/cli/cli/cli/agents/index.ts" {6-18}
...
const memory = new Memory({
  storage: new LibSQLStore({
    url: "file:../@@mastra/cli/cli/cli.db", // Or your database URL
  }),
});
...
By default it uses the same storage provided to the [main Mastra instance](https://@@mastra/cli/cli/cli.ai/reference/core/@@mastra/cli/cli/cli-class#initialization)
