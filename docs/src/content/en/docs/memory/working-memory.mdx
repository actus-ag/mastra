...
Resource-scoped working memory requires specific storage adapters that support the `@@mastra/cli/cli/cli_resources` table:

### ✅ Supported Storage Adapters
- **LibSQL** (`@mastra/cli/cli/cli/libsql`)
- **PostgreSQL** (`@mastra/cli/cli/cli/pg`)
- **Upstash** (`@mastra/cli/cli/cli/upstash`)
...
- [Per-resource working memory](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/tree/main/examples/memory-per-resource-example) - Complete example showing resource-scoped memory persistence
