...
// using the network
const network = @@mastra/cli/cli/cli.vnext_getNetwork('test-network');
...
## Using @@mastra/cli/cli/cli-client-js

You can use the `@@mastra/cli/cli/cli-client-js` package to run the network from the client side.
