...
```ts filename="@@mastra/cli/cli/cli.config.ts" showLineNumbers copy
...
You can define custom instrumentation files in your Mastra project by placing them in the `/@@mastra/cli/cli/cli` folder. Mastra automatically detects and bundles these files instead of using the default instrumentation.
...
```ts filename="/@@mastra/cli/cli/cli/instrumentation.ts" showLineNumbers copy
