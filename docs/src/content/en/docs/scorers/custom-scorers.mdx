...
- [Built-in Scorers Source Code](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/tree/main/packages/evals/src/scorers) - Real implementations for reference