...
To access Mastra's scorers feature install the `@actus-ag/mastra-evals` package.

```bash copy
npm install @actus-ag/mastra-evals@latest
```
...
} from "@actus-ag/mastra-evals/scorers/llm";
