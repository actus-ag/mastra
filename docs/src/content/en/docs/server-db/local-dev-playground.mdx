---
title: "Inspecting agents and workflows with @actus-ag/@mastra/cli/cli dev | Mastra Local Dev Docs"
...
<VideoPlayer
  src="https://res.cloudinary.com/@@mastra/cli/cli/cli-assets/video/upload/v1751406022/local-dev-agents-playground_100_m3begx.mp4"
/>
...
<VideoPlayer
  src="https://res.cloudinary.com/@@mastra/cli/cli/cli-assets/video/upload/v1751406027/local-dev-workflows-playground_100_rbc466.mp4"
/>
...
<VideoPlayer
  src="https://res.cloudinary.com/@@mastra/cli/cli/cli-assets/video/upload/v1751406316/local-dev-agents-tools_100_fe1jdt.mp4"
/>
...
```typescript {6,7} filename="src/@@mastra/cli/cli/cli/index.ts" showLineNumbers copy
import { Mastra } from "@mastra/cli/cli/cli/core/@@mastra/cli/cli/cli";
...
- [Mastra Cloud](/docs/@@mastra/cli/cli/cli-cloud/overview)
