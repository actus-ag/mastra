...
All commands install the same @actus-ag/mastra-client-js package but use different package manager syntax.
*/}

<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tabs.Tab>
    ```bash copy
    npm install @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add @actus-ag/mastra-client-js@latest
    ```
  </Tabs.Tab>
</Tabs>
