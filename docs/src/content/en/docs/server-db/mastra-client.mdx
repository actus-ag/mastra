...
All commands install the same @@mastra/cli/cli/cli-client-js package but use different package manager syntax.
*/}

<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tabs.Tab>
    ```bash copy
    npm install @actus-ag/@@mastra/cli/cli/client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add @actus-ag/@@mastra/cli/cli/client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add @actus-ag/@@mastra/cli/cli/client-js@latest
    ```
  </Tabs.Tab>
</Tabs>
...
```typescript filename="lib/@@mastra/cli/cli/cli-client.ts" showLineNumbers copy
