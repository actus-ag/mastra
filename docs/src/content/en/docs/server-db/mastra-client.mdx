...
All commands install the same @datawarp/mastra-client-js package but use different package manager syntax.
*/}

<Tabs items={["npm", "yarn", "pnpm"]}>
  <Tabs.Tab>
    ```bash copy
    npm install @datawarp/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    yarn add @datawarp/mastra-client-js@latest
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
    pnpm add @datawarp/mastra-client-js@latest
    ```
  </Tabs.Tab>
</Tabs>
