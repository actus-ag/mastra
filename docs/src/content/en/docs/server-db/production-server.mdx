...
Mastra uses [Hono](https://hono.dev) as its underlying HTTP server framework. When you build a Mastra application using `@actus-ag/@mastra/cli/cli build`, it generates a Hono-based HTTP server in the `.@@mastra/cli/cli/cli` directory.
