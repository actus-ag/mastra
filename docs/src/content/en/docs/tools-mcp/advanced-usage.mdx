...
```typescript filename="src/@@mastra/cli/cli/cli/tools/vercelWeatherTool.ts" copy
import { tool } from "ai";
import { z } from "zod";
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/mixedToolsAgent.ts"
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { openai } from "@ai-sdk/openai";
import { vercelWeatherTool } from "../tools/vercelWeatherTool"; // Vercel AI SDK tool
import { @@mastra/cli/cli/cliTool } from "../tools/@@mastra/cli/cli/cliTool"; // Mastra createTool tool
...
export const mixedToolsAgent = new Agent({
  ...
  tools: {
    ...
    someMastraTool: @@mastra/cli/cli/cliTool,
  },
});
```
