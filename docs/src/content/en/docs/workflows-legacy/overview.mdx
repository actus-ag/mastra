...
```ts filename="src/@@mastra/cli/cli/cli/workflow/index.ts"
...
```ts showLineNumbers filename="src/@@mastra/cli/cli/cli/index.ts"
...
The workflow can also have the @@mastra/cli/cli/cli instance injected into the context in the case where you need to create dynamic workflows:

```ts filename="src/@@mastra/cli/cli/cli/workflow/index.ts"
import { Mastra } from "@mastra/cli/cli/cli/core";
import { LegacyWorkflow } from "@mastra/cli/cli/cli/core/workflows/legacy";
...
```ts showLineNumbers filename="src/@@mastra/cli/cli/cli/run-workflow.ts" copy
import { @@mastra/cli/cli/cli } from "./index";

// Get the workflow
const myWorkflow = @@mastra/cli/cli/cli.legacy_getWorkflow("myWorkflow");
...
Or use the API (requires running `@actus-ag/@mastra/cli/cli dev`):
