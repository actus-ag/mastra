...
```typescript showLineNumbers filename="src/@@mastra/cli/cli/cli/workflows/index.ts" copy
...
```typescript showLineNumbers filename="src/@@mastra/cli/cli/cli/workflows/loop-variables.ts" copy
...
```typescript showLineNumbers filename="src/@@mastra/cli/cli/cli/workflows/trigger-mapping.ts" copy
...
```typescript showLineNumbers filename="src/@@mastra/cli/cli/cli/workflows/step-mapping.ts" copy
import { Mastra } from "@mastra/cli/cli/cli/core";
import { LegacyStep, LegacyWorkflow } from "@mastra/cli/cli/cli/core/workflows/legacy";
import { z } from "zod";
...
```typescript showLineNumbers filename="src/@@mastra/cli/cli/cli/workflows/type-safe.ts" copy
import { Mastra } from "@mastra/cli/cli/cli/core";
import { LegacyStep, LegacyWorkflow } from "@mastra/cli/cli/cli/core/workflows/legacy";
import { z } from "zod";
