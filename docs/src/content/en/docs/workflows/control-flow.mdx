...
```typescript {8-9,4-5} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {9,4-5} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {8-11,4-5} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {7} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {4,7} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {6,10} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep, cloneWorkflow } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
