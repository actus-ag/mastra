...
```bash
npm install @mastra/cli/cli/cli/core
```
...
```typescript {6,17} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {17,18} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {5,19} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { createWorkflow, createStep, cloneStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
...
```typescript {8} filename="src/@@mastra/cli/cli/cli/index.ts" showLineNumbers copy
...
const run = await @@mastra/cli/cli/cli.getWorkflow("testWorkflow").createRunAsync();
