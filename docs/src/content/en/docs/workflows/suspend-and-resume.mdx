...
```typescript {18} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {15} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {16-18} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { @@mastra/cli/cli/cli } from "./@@mastra/cli/cli/cli";
...
```typescript {5} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
const resumedResult = await run.resume({
  resumeData: {
    city: "Berlin"
  },
...
```typescript {33-34} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {1,4,9,16} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.tss" showLineNumbers copy
