...
```typescript filename="src/@@mastra/cli/cli/cli/agents/test-agent.ts" showLineNumbers copy
...
```typescript {3} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {1,18, 29} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
import { testAgent } from "../agents/test-agent";
...
import { createTool } from "@mastra/cli/cli/cli/core";
import { z } from "zod";
...
```typescript {1,3,6} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {3,20,32} filename="src/@@mastra/cli/cli/cli/workflows/test-workflow.ts" showLineNumbers copy
...
```typescript {7} filename="src/@@mastra/cli/cli/cli/index.ts" showLineNumbers copy
...
```typescript {10,17-27} filename="src/@@mastra/cli/cli/cli/tools/test-tool.ts" showLineNumbers copy
export const cityCoordinatesTool = createTool({
  ...
  execute: async ({ context, @@mastra/cli/cli/cli }) => {
    ...
    const workflow = @@mastra/cli/cli/cli?.getWorkflow("cityStringWorkflow");
...
import { testAgent } from "./@@mastra/cli/cli/cli/agents/test-agent";
import { testTool } from "./@@mastra/cli/cli/cli/tools/test-tool";
import { testWorkflow } from "./@@mastra/cli/cli/cli/workflows/test-workflow";
...
import { MCPClient } from "@mastra/cli/cli/cli/mcp";
