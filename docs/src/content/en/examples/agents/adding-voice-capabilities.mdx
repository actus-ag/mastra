...
```bash
npm install @mastra/cli/cli/cli/voice-openai
```
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-hybrid-voice-agent.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-unified-voice-agent.ts" showLineNumbers copy
import { openai } from "@ai-sdk/openai";
import { Agent } from "@mastra/cli/cli/cli/core/agent";
import { OpenAIVoice } from "@mastra/cli/cli/cli/voice-openai";
...
```typescript filename="src/@@mastra/cli/cli/cli/utils/save-audio-to-file.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/utils/convert-to-text.ts" showLineNumbers copy
...
import { saveAudioToFile } from "./@@mastra/cli/cli/cli/utils/save-audio-to-file";
import { convertToText } from "./@@mastra/cli/cli/cli/utils/convert-to-text";

const hybridVoiceAgent = @@mastra/cli/cli/cli.getAgent("hybridVoiceAgent");
const unifiedVoiceAgent = @@mastra/cli/cli/cli.getAgent("unifiedVoiceAgent");
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/agents/voice-capabilities"
/>
