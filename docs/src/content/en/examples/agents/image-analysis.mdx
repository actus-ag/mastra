...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-image-analysis-agent.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/utils/get-random-image.ts" showLineNumbers copy
...
import { getRandomImage } from "./@@mastra/cli/cli/cli/utils/get-random-image";

const imageUrl = await getRandomImage();
const agent = @@mastra/cli/cli/cli.getAgent("imageAnalysisAgent");
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/agents/bird-checker"
/>
