...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-copywriter-agent.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/tools/example-copywriter-tool.ts"
...
export const copywriterTool = createTool({
  ...
  execute: async ({ context, @@mastra/cli/cli/cli }) => {
    ...
    const agent = @@mastra/cli/cli/cli!.getAgent("copywriterAgent");
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-editor-agent.ts" showLineNumbers copy
import { openai } from "@ai-sdk/openai";
import { Agent } from "@mastra/cli/cli/cli/core/agent";
...
```typescript filename="src/@@mastra/cli/cli/cli/tools/example-editor-tool.ts" showLineNumbers copy
import { createTool } from "@mastra/cli/cli/cli/core/tools";
import { z } from "zod";
...
export const editorTool = createTool({
  ...
  execute: async ({ context, @@mastra/cli/cli/cli }) => {
    ...
    const agent = @@mastra/cli/cli/cli!.getAgent("editorAgent");
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-publisher-agent.ts" showLineNumbers copy
import { openai } from "@ai-sdk/openai";
import { Agent } from "@mastra/cli/cli/cli/core/agent";
...
const agent = @@mastra/cli/cli/cli.getAgent("publisherAgent");
...
<GithubLink
  outdated={true}
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/agents/supervisor-agent"
/>
