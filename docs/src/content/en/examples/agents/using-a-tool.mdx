...
```typescript filename="src/@@mastra/cli/cli/cli/tools/example-london-weather-tool.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-london-weather-agent.ts" showLineNumbers copy
...
const agent = @@mastra/cli/cli/cli.getAgent("londonWeatherAgent");
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/agents/using-a-tool"
/>
