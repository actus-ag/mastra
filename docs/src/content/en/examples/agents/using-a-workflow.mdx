...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-soccer-workflow.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-soccer-agent.ts" showLineNumbers copy
...
const agent = @@mastra/cli/cli/cli.getAgent("soccerAgent");
