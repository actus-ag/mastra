...
import { ContextPrecisionMetric } from "@mastra/cli/cli/cli/evals/llm";
...
<GithubLink
  outdated={true}
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/evals/context-precision"
/>
