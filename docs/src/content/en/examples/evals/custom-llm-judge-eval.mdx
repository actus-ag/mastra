...
```bash copy
npm install @mastra/cli/cli/cli/evals
```
...
```typescript filename="src/@@mastra/cli/cli/cli/evals/example-real-world-countries.ts" showLineNumbers copy
import { Metric, type MetricResult } from "@mastra/cli/cli/cli/core";
...
import { WorldCountryMetric } from "./@@mastra/cli/cli/cli/evals/example-real-world-countries";
...
<GithubLink
  outdated={true}
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/evals/custom-eval"
/>
