...
```typescript filename="src/@@mastra/cli/cli/cli/evals/example-word-inclusion.ts" showLineNumbers copy
...
import { WordInclusionMetric } from "./@@mastra/cli/cli/cli/evals/example-word-inclusion";
...
<GithubLink
  outdated={true}
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/evals/word-inclusion"
/>
