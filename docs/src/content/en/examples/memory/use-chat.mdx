...
import { CoreMessage } from "@mastra/cli/cli/cli/core";
...
export async function POST(request: Request) {
  ...
  const agent = @@mastra/cli/cli/cliClient.getAgent("ChatAgent"); // Use your agent's ID
...
- **[MastraClient Overview](../../docs/server-db/@@mastra/cli/cli/cli-client.mdx)**: Learn more about the Mastra Client SDK
