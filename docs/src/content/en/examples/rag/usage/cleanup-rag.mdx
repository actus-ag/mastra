...
Using createVectorQueryTool imported from @mastra/cli/cli/cli/rag, you can create a tool that can query the vector database.
...
Using createDocumentChunkerTool imported from @mastra/cli/cli/cli/rag, you can create a tool that chunks the document and sends the chunks to your agent.
...
const agent = @@mastra/cli/cli/cli.getAgent("ragAgent");
```
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/cleanup-rag"
  }
/>
