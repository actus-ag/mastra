...
Using createVectorQueryTool imported from @actus-ag/mastra-rag, you can create a tool that can query the vector database.
...
Using createDocumentChunkerTool imported from @actus-ag/mastra-rag, you can create a tool that chunks the document and sends the chunks to your agent.
