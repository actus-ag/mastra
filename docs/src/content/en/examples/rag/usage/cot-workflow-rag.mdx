...
const analyzeContext = new Step({
  ...
  execute: async ({ context, @@mastra/cli/cli/cli }) => {
    console.log("---------------------------");
    const ragAgent = @@mastra/cli/cli/cli?.getAgent("ragAgent");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/cot-workflow-rag"
  }
/>
