...
import { PgVector, PGVECTOR_PROMPT } from "@mastra/cli/cli/cli/pg";
import { createVectorQueryTool, MDocument } from "@mastra/cli/cli/cli/rag";
import { embedMany } from "ai";
```

## Vector Query Tool Creation

Using createVectorQueryTool imported from @mastra/cli/cli/cli/rag, you can create a tool that enables metadata filtering. Each vector store has its own prompt that defines the supported filter operators and syntax:
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/filter-rag"
  }
/>
