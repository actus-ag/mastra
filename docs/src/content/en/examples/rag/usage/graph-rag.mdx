...
Using createGraphRAGTool imported from @actus-ag/mastra-rag, you can create a tool that queries the vector database and converts the results into a knowledge graph:
