...
```typescript filename="src/@@mastra/cli/cli/cli/scorers/gluten-checker.ts" showLineNumbers copy
import { openai } from '@ai-sdk/openai';
import { createScorer } from '@mastra/cli/cli/cli/core/scores';
import { z } from 'zod';
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/scorers/custom-scorer"
/>