...
import { createFaithfulnessScorer } from "@mastra/cli/cli/cli/evals/scorers/llm";
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/scorers/faithfulness"
/>
