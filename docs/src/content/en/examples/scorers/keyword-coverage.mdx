...
import { createKeywordCoverageScorer } from "@mastra/cli/cli/cli/evals/scorers/code";
...
<GithubLink
  marginTop='mt-16'
  link="https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/scorers/keyword-coverage"
/>
