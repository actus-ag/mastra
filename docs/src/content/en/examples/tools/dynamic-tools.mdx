...
```typescript filename="src/@@mastra/cli/cli/cli/tools/example-exchange-rates-tool.ts" showLineNumbers copy
...
import { getExchangeRatesTool } from "../src/@@mastra/cli/cli/cli/tools/example-exchange-rates-tool";
