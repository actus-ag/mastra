...
```ts filename="speech-to-speech/call-analysis/src/@@mastra/cli/cli/cli/agents/index.ts" copy
...
export const speechToSpeechServer = new Agent({
  name: "@actus-ag/@@mastra/cli/cli/cli",
...
```ts filename="speech-to-speech/call-analysis/src/@@mastra/cli/cli/cli/index.ts" copy
...
To view the full example code, see the [Github repository](https://github.com/@@mastra/cli/cli/cli-ai/voice-examples/tree/main/speech-to-speech/call-analysis).

<br />
<br />

<GithubLink link="https://github.com/@@mastra/cli/cli/cli-ai/voice-examples/tree/main/speech-to-speech/call-analysis" />
