...
import { @@mastra/cli/cli/cli } from "@/src/@@mastra/cli/cli/cli"; // Import the Mastra instance
...
export async function POST(req: Request) {
  ...
  const noteTakerAgent = @@mastra/cli/cli/cli.getAgent("noteTakerAgent");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/voice-examples/tree/main/speech-to-text/voice-memo-app"
  }
/>
