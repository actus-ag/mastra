...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-city-agent.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-call-agent.ts" showLineNumbers copy
...
const step1 = createStep({
  ...
  execute: async ({ inputData, @@mastra/cli/cli/cli }) => {
    ...
    const agent = @@mastra/cli/cli/cli.getAgent("cityAgent");
