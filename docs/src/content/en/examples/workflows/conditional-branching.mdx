...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-branch-steps.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-branch-workflows.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
