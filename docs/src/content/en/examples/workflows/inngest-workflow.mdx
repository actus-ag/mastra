...
```sh copy
npm install @mastra/cli/cli/cli/inngest inngest @mastra/cli/cli/cli/core @mastra/cli/cli/cli/deployer @hono/node-server @ai-sdk/openai
...
import { init } from "@mastra/cli/cli/cli/inngest";
import { Inngest } from "inngest";
import { z } from "zod";

const { createWorkflow, createStep } = init(
  new Inngest({
    id: "@actus-ag/@@mastra/cli/cli/cli",
...
const planActivities = createStep({
  ...
  execute: async ({ inputData, @@mastra/cli/cli/cli }) => {
    ...
    const agent = @@mastra/cli/cli/cli?.getAgent("planningAgent");
    if (!agent) {
...
Register the agents and workflow with the @@mastra/cli/cli/cli instance. This allows access to the agents within the workflow.

```ts showLineNumbers copy filename="index.ts"
import { Mastra } from "@mastra/cli/cli/cli/core/@@mastra/cli/cli/cli";
import { serve as inngestServe } from "@mastra/cli/cli/cli/inngest";
    ...
    apiRoutes: [
      {
        ...
        method: "ALL",
        createHandler: async ({ @@mastra/cli/cli/cli }) => inngestServe({ @@mastra/cli/cli/cli, inngest }),
      },
    ],
  },
...
Here, we'll get the activity planner workflow from the @@mastra/cli/cli/cli instance, then create a run and execute the created run with the required inputData.

```ts showLineNumbers copy filename="exec.ts"
import { @@mastra/cli/cli/cli } from "./";
import { serve } from "@hono/node-server";
import {
  createHonoServer,
  getToolExports,
} from "@mastra/cli/cli/cli/deployer/server";
import { tools } from "#tools";

const app = await createHonoServer(@@mastra/cli/cli/cli, {
...
const workflow = @@mastra/cli/cli/cli.getWorkflow("activityPlanningWorkflow");
