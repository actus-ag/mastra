...
```sh copy
npm install @actus-ag/mastra-inngest inngest @actus-ag/mastra-core @actus-ag/mastra-deployer @hono/node-server @ai-sdk/openai
...
import { init } from "@actus-ag/mastra-inngest";
...
import { serve as inngestServe } from "@actus-ag/mastra-inngest";
...
import {
  createHonoServer,
  getToolExports,
} from "@actus-ag/mastra-deployer/server";
