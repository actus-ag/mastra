...
```sh copy
npm install @datawarp/mastra-inngest inngest @datawarp/mastra-core @datawarp/mastra-deployer @hono/node-server @ai-sdk/openai
...
import { init } from "@datawarp/mastra-inngest";
...
import { serve as inngestServe } from "@datawarp/mastra-inngest";
...
import {
  createHonoServer,
  getToolExports,
} from "@datawarp/mastra-deployer/server";
