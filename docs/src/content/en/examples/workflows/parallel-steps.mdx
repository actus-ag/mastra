...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-parallel-steps.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-parallel-workflows.ts" showLineNumbers copy
import { createWorkflow, createStep } from "@mastra/cli/cli/cli/core/workflows";
import { z } from "zod";
