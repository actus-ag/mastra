...
```typescript filename="src/@@mastra/cli/cli/cli/tools/example-reverse-tool.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/workflows/example-tool-step.ts" showLineNumbers copy
