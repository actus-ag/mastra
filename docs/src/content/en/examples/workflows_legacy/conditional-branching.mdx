...
async function runWorkflow(inputValue: number) {
  const workflow = @@mastra/cli/cli/cli.legacy_getWorkflow("conditionalWorkflow");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/workflows-legacy/conditional-branching"
  }
/>
