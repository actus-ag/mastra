...
async function runRecommendationWorkflow() {
  const registeredWorkflow = @@mastra/cli/cli/cli.legacy_getWorkflow(
    "recommendationWorkflow",
  );
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/workflows-legacy/human-in-the-loop"
  }
/>
