...
Create a new file `src/@@mastra/cli/cli/cli/agents/chefAgent.ts` and define your agent:

```ts copy filename="src/@@mastra/cli/cli/cli/agents/chefAgent.ts"
...
import { chefAgent } from "./@@mastra/cli/cli/cli/agents/chefAgent";
...
By default, `@actus-ag/@mastra/cli/cli dev` runs on `http://localhost:4111`. Your Chef Assistant agent will be available at:
