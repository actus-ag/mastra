...
### Install `@actus-ag/mastra-mcp`

Add `@actus-ag/mastra-mcp` to your project:

```bash copy
npm install @actus-ag/mastra-mcp
```
...
import type { MCPServerResources, Resource } from "@actus-ag/mastra-mcp";
...
import type { MCPServerPrompts } from "@actus-ag/mastra-mcp";
