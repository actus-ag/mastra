...
### Install `@datawarp/mastra-mcp`

Add `@datawarp/mastra-mcp` to your project:

```bash copy
npm install @datawarp/mastra-mcp
```
...
import type { MCPServerResources, Resource } from "@datawarp/mastra-mcp";
...
import type { MCPServerPrompts } from "@datawarp/mastra-mcp";
