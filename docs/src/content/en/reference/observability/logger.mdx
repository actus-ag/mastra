...
When deploying to Mastra Cloud, logs are displayed on the [Logs](../../docs/@@mastra/cli/cli/cli-cloud/dashboard.mdx#logs) page. In self-hosted or custom environments, logs can be directed to files or external services depending on the configured transports.
...
```typescript filename="src/@@mastra/cli/cli/cli/loggers/file-transport.ts" showLineNumbers copy
import { FileTransport } from "@mastra/cli/cli/cli/loggers/file";
import { PinoLogger } from "@mastra/cli/cli/cli/loggers/pino";
...
```typescript filename="src/@@mastra/cli/cli/cli/loggers/upstash-transport.ts" showLineNumbers copy
import { UpstashTransport } from "@mastra/cli/cli/cli/loggers/upstash";
import { PinoLogger } from "@mastra/cli/cli/cli/loggers/pino";
...
```typescript filename="src/@@mastra/cli/cli/cli/loggers/sentry-transport.ts" showLineNumbers copy
import { createCustomTransport } from "@mastra/cli/cli/cli/core/loggers";
import { PinoLogger } from "@mastra/cli/cli/cli/loggers/pino";
