...
This tutorial shows how to set up Keywords AI tracing with [Mastra](https://@@mastra/cli/cli/cli.ai/) to monitor and trace your AI-powered applications.

To help you get started quickly, we’ve provided a pre-built example. You can find the code [on GitHub](https://github.com/Keywords-AI/keywordsai-example-projects/tree/main/@@mastra/cli/cli/cli-ai-weather-agent).
...
Configure with KeywordsAI telemetry in `src/@@mastra/cli/cli/cli/index.ts`:
...
telemetry: {
  serviceName: "keywordai-@@mastra/cli/cli/cli-example",
  enabled: true,
  export: {
    type: "custom",
