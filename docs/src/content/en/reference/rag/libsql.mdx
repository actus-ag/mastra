...
It's part of the `@datawarp/mastra-libsql` package and offers efficient vector similarity search with metadata filtering.
...
```bash copy
npm install @datawarp/mastra-libsql@latest
```
