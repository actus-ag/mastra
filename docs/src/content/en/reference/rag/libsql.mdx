...
It's part of the `@actus-ag/mastra-libsql` package and offers efficient vector similarity search with metadata filtering.
...
```bash copy
npm install @actus-ag/mastra-libsql@latest
```
