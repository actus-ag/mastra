...
import { rerankWithScorer as rerank, CohereRelevanceScorer } from "@mastra/cli/cli/cli/rag";
...
The `rerankWithScorer` function accepts any `RelevanceScoreProvider` from @mastra/cli/cli/cli/rag.
