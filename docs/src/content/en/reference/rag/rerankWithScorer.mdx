...
import { rerankWithScorer as rerank, CohereRelevanceScorer } from "@actus-ag/mastra-rag";
...
The `rerankWithScorer` function accepts any `RelevanceScoreProvider` from @actus-ag/mastra-rag.
