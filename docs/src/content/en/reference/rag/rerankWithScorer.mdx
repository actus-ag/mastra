...
import { rerankWithScorer as rerank, CohereRelevanceScorer } from "@datawarp/mastra-rag";
...
The `rerankWithScorer` function accepts any `RelevanceScoreProvider` from @datawarp/mastra-rag.
