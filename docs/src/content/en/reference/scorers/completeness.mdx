...
This function returns an instance of the MastraScorer class. See the [MastraScorer reference](./@@mastra/cli/cli/cli-scorer) for details on the `.run()` method and its input/output.
