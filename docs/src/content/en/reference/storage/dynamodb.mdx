...
```bash copy
npm install @mastra/cli/cli/cli/dynamodb@latest
# or
pnpm add @mastra/cli/cli/cli/dynamodb@latest
# or
yarn add @mastra/cli/cli/cli/dynamodb@latest
```
...
Detailed instructions for setting up the table using AWS CloudFormation or AWS CDK are available in [TABLE_SETUP.md](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/stores/dynamodb/TABLE_SETUP.md). Please ensure your table is configured according to those instructions before proceeding.
...
import { DynamoDBStore } from "@mastra/cli/cli/cli/dynamodb";

// Initialize the DynamoDB storage
const storage = new DynamoDBStore({
  name: "dynamodb", // A name for this storage instance
  config: {
    tableName: "@@mastra/cli/cli/cli-single-table", // Name of your DynamoDB table
...
2.  **Configure `DynamoDBStore` to use the local endpoint:**
    ...
    const storage = new DynamoDBStore({
      name: "dynamodb-local",
      config: {
        tableName: "@@mastra/cli/cli/cli-single-table", // Ensure this table is created in your local DynamoDB
...
- **External Table Provisioning:** This adapter _requires_ you to create and configure the DynamoDB table and its Global Secondary Indexes (GSIs) yourself, prior to using the adapter. Follow the guide in [TABLE_SETUP.md](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/stores/dynamodb/TABLE_SETUP.md).
...
This package is distributed under the MIT License. See [LICENSE.md](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/LICENSE.md) for more information.
