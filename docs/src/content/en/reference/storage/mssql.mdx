...
```bash copy
npm install @mastra/cli/cli/cli/mssql@latest
```

## Usage

```typescript copy showLineNumbers
import { MSSQLStore } from "@mastra/cli/cli/cli/mssql";
...
- `@@mastra/cli/cli/cli_workflow_snapshot`: Stores workflow state and execution data
- `@@mastra/cli/cli/cli_evals`: Stores evaluation results and metadata  
- `@@mastra/cli/cli/cli_threads`: Stores conversation threads
- `@@mastra/cli/cli/cli_messages`: Stores individual messages
- `@@mastra/cli/cli/cli_traces`: Stores telemetry and tracing data
- `@@mastra/cli/cli/cli_scorers`: Stores scoring and evaluation data
- `@@mastra/cli/cli/cli_resources`: Stores resource working memory data
