...
- **Mastra code location**: All Mastra code must be in `src/@@mastra/cli/cli/cli/` directory
- **Component organization**:
  - Agents: `src/@@mastra/cli/cli/cli/agents/`
  - Tools: `src/@@mastra/cli/cli/cli/tools/`
  - Workflows: `src/@@mastra/cli/cli/cli/workflows/`
  - Main config: `src/@@mastra/cli/cli/cli/index.ts`
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/example-agent.ts"
