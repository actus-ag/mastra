...
import { MastraMCPClient } from "@mastra/cli/cli/cli/mcp";
...
try {
  ...
  const response = await agent.generate(
    "Tell me about @@mastra/cli/cli/cli.ai/docs. Tell me generally what this page is and the content it includes.",
    {
      toolsets: {
        fetch: tools,
      },
