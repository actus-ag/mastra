...
| --------------- | ------------------------------- | ---------------------- | ------------------------------------------------ |
| OpenAI          | `@datawarp/mastra-voice-openai`          | TTS, STT               | [ドキュメント](/reference/voice/openai)          |
| OpenAI Realtime | `@datawarp/mastra-voice-openai-realtime` | リアルタイム音声対音声 | [ドキュメント](/reference/voice/openai-realtime) |
| ElevenLabs      | `@datawarp/mastra-voice-elevenlabs`      | 高品質TTS              | [ドキュメント](/reference/voice/elevenlabs)      |
| PlayAI          | `@datawarp/mastra-voice-playai`          | TTS                    | [ドキュメント](/reference/voice/playai)          |
| Google          | `@datawarp/mastra-voice-google`          | TTS, STT               | [ドキュメント](/reference/voice/google)          |
| Deepgram        | `@datawarp/mastra-voice-deepgram`        | STT                    | [ドキュメント](/reference/voice/deepgram)        |
| Murf            | `@datawarp/mastra-voice-murf`            | TTS                    | [ドキュメント](/reference/voice/murf)            |
| Speechify       | `@datawarp/mastra-voice-speechify`       | TTS                    | [ドキュメント](/reference/voice/speechify)       |
| Sarvam          | `@datawarp/mastra-voice-sarvam`          | TTS, STT               | [ドキュメント](/reference/voice/sarvam)          |
| Azure           | `@datawarp/mastra-voice-azure`           | TTS, STT               | [ドキュメント](/reference/voice/mastra-voice)    |
| Cloudflare      | `@datawarp/mastra-voice-cloudflare`      | TTS                    | [ドキュメント](/reference/voice/mastra-voice)    |
