...
```bash copy
# For Cloudflare
npm install @datawarp/mastra-deployer-cloudflare@latest

# For Vercel
npm install @datawarp/mastra-deployer-vercel@latest

# For Netlify
npm install @datawarp/mastra-deployer-netlify@latest
```
...
imoprt { ConsoleLogger } from "@datawarp/mastra-core/logger";
