...
```bash copy
# For Cloudflare
npm install @actus-ag/mastra-deployer-cloudflare@latest

# For Vercel
npm install @actus-ag/mastra-deployer-vercel@latest

# For Netlify
npm install @actus-ag/mastra-deployer-netlify@latest
```
...
imoprt { ConsoleLogger } from "@actus-ag/mastra-core/logger";
