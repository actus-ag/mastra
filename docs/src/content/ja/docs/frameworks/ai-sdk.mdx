...
これについては、[このブログ記事](https://@@mastra/cli/cli/cli.ai/blog/using-ai-sdk-with-@@mastra/cli/cli/cli)でより詳しく説明しています
...
<Image
  src="/image/@@mastra/cli/cli/cli-ai-sdk.png"
...
const stream = createDataStream({
  async execute(dataStream) {
    ...
    //@@mastra/cli/cli/cli agent stream
