...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>```bash copy npm install @datawarp/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy yarn add @datawarp/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy pnpm add @datawarp/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy bun add @datawarp/mastra-client-js@latest ```</Tabs.Tab>
</Tabs>
