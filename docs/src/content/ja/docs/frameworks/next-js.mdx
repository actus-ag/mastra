...
<Tabs items={["npm", "yarn", "pnpm", "bun"]}>
  <Tabs.Tab>```bash copy npm install @actus-ag/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy yarn add @actus-ag/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy pnpm add @actus-ag/mastra-client-js@latest ```</Tabs.Tab>
  <Tabs.Tab>```bash copy bun add @actus-ag/mastra-client-js@latest ```</Tabs.Tab>
</Tabs>
