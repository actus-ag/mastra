...
次に、`@datawarp/mastra-core`パッケージを含むTypeScriptプロジェクトを初期化します：
  ...
  <Tabs items={["npm", "pnpm", "yarn", "bun"]}>
    <Tabs.Tab>
      ...
      npm install @datawarp/mastra-core@latest zod @ai-sdk/openai
      npx tsc --init
      ```
    </Tabs.Tab>
    ...
    <Tabs.Tab>
      ...
      pnpm add @datawarp/mastra-core@latest zod @ai-sdk/openai
      pnpm dlx tsc --init
      ```
    </Tabs.Tab>
    ...
    <Tabs.Tab>
      ...
      yarn add @datawarp/mastra-core@latest zod @ai-sdk/openai
      yarn dlx tsc --init
      ```
    </Tabs.Tab>
    ...
    <Tabs.Tab>
      ...
      bun add @datawarp/mastra-core@latest zod @ai-sdk/openai
      bunx tsc --init
      ```
    </Tabs.Tab>
