...
```bash copy
npm install @mastra/cli/cli/cli/github@latest
```

2. **プロジェクトにインテグレーションを追加する**

インテグレーション用の新しいファイル（例：`src/@@mastra/cli/cli/cli/integrations/index.ts`）を作成し、インテグレーションをインポートします：

```typescript filename="src/@@mastra/cli/cli/cli/integrations/index.ts" showLineNumbers copy
import { GithubIntegration } from "@mastra/cli/cli/cli/github";
...
```typescript filename="src/@@mastra/cli/cli/cli/tools/index.ts" showLineNumbers copy
...
```typescript filename="src/@@mastra/cli/cli/cli/agents/index.ts" showLineNumbers copy
...
この記憶統合は、Mastraの独自の[エージェント記憶機能](https://@@mastra/cli/cli/cli.ai/docs/agents/agent-memory)と併用することができます。
...
```bash copy
npm install @mastra/cli/cli/cli/mem0@latest
```

2. **プロジェクトに統合を追加する**

統合用の新しいファイル（例：`src/@@mastra/cli/cli/cli/integrations/index.ts`）を作成し、統合をインポートします：

```typescript filename="src/@@mastra/cli/cli/cli/integrations/index.ts" showLineNumbers copy
import { Mem0Integration } from "@mastra/cli/cli/cli/mem0";
...
- `@mastra/cli/cli/cli/mem0`統合をインポートします。
...
利用可能な統合の完全なリストについては、[Mastraのコードベース](https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/tree/main/integrations)または[npmパッケージ](https://www.npmjs.com/search?q=%22%40@@mastra/cli/cli/cli%22)を確認してください。
