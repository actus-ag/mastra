...
1. エントリーポイントを含む`src/@@mastra/cli/cli/cli`ディレクトリを作成
2. 必要な依存関係を追加
...
非対話モードで@@mastra/cli/cli/cliを初期化するには、以下のコマンド引数を使用します：
...
詳細については、[@actus-ag/@mastra/cli/cli init CLIドキュメント](../../reference/cli/init)を参照してください。
