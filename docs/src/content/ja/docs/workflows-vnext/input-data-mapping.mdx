...
const step1 = createStep({
  ...
  execute: async ({ inputData, @@mastra/cli/cli/cli }) => {
    @@mastra/cli/cli/cli.getLogger()?.debug(`Step 1 received: ${inputData.inputValue}`);
...
const step2 = createStep({
  ...
  execute: async ({ inputData, @@mastra/cli/cli/cli }) => {
    @@mastra/cli/cli/cli.getLogger()?.debug(`Step 2 received: ${inputData.unexpectedName}`);
...
const run = @@mastra/cli/cli/cli.vnext_getWorkflow("myWorkflow").createRun();
...
const step3 = createStep({
  ...
  execute: async ({ inputData, @@mastra/cli/cli/cli }) => {
    @@mastra/cli/cli/cli.getLogger()?.debug(`Step 3 combining all previous data`);
    return {
