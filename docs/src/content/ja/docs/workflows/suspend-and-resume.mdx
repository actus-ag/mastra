...
```typescript
// ワークフローを取得し、実行を作成
const wf = @@mastra/cli/cli/cli.getWorkflow("multi-suspend-workflow");
...
```bash copy
npm install @mastra/cli/cli/cli/upstash@latest
```

```typescript
import { Mastra } from "@mastra/cli/cli/cli/core/@@mastra/cli/cli/cli";
import { UpstashStore } from "@mastra/cli/cli/cli/upstash";
...
```typescript
// ワークフローを取得
const workflow = @@mastra/cli/cli/cli.getWorkflow("approval-workflow");
...
```typescript
import { Mastra } from "@mastra/cli/cli/cli/core/@@mastra/cli/cli/cli";
import { DefaultStorage } from "@mastra/cli/cli/cli/core/storage/libsql";
...
```bash
npm install @mastra/cli/cli/cli/upstash
```
