...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/evals/recipe-completeness/prompts.ts"
...
```typescript copy showLineNumbers{3} filename="src/@@mastra/cli/cli/cli/evals/recipe-completeness/prompts.ts"
...
```typescript copy showLineNumbers{34} filename="src/@@mastra/cli/cli/cli/evals/recipe-completeness/prompts.ts"
...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/evals/gluten-checker/metricJudge.ts"
import { type LanguageModel } from "@mastra/cli/cli/cli/core/llm";
import { MastraAgentJudge } from "@mastra/cli/cli/cli/evals/judge";
import { z } from "zod";
import {
  GLUTEN_INSTRUCTIONS,
...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/evals/gluten-checker/index.ts"
...
```typescript copy showLineNumbers filename="src/@@mastra/cli/cli/cli/agents/chefAgent.ts"
...
const chefAgent = @@mastra/cli/cli/cli.getAgent("chefAgent");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/evals/custom-eval"
  }
/>
