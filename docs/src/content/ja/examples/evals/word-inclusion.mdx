...
import { Metric, type MetricResult } from "@mastra/cli/cli/cli/core/eval";
```
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/evals/word-inclusion"
  }
/>
