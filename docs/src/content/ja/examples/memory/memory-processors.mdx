...
```bash copy
npm install @mastra/cli/cli/cli/memory@latest
# or
pnpm add @mastra/cli/cli/cli/memory@latest
# or
yarn add @mastra/cli/cli/cli/memory@latest
```
...
import { TokenLimiter, ToolCallFilter } from "@mastra/cli/cli/cli/memory/processors";
...
```typescript
import { Memory } from "@mastra/cli/cli/cli/memory";
import { TokenLimiter } from "@mastra/cli/cli/cli/memory/processors";
...
```typescript
import { Memory } from "@mastra/cli/cli/cli/memory";
import { ToolCallFilter } from "@mastra/cli/cli/cli/memory/processors";
...
```typescript
import type { CoreMessage } from "@mastra/cli/cli/cli/core";
import { MemoryProcessor } from "@mastra/cli/cli/cli/core/memory";
import { Memory } from "@mastra/cli/cli/cli/memory";
...
import { Memory, TokenLimiter, ToolCallFilter } from "@mastra/cli/cli/cli/memory";
