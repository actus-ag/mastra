...
import { MDocument, createVectorQueryTool } from "@mastra/cli/cli/cli/rag";
import { embedMany } from "ai";
```

## リランキング付きベクタークエリツールの作成

@mastra/cli/cli/cli/rag からインポートした createVectorQueryTool を使用すると、ベクターデータベースにクエリを実行し、結果をリランキングするツールを作成できます。
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/rerank-rag"
  }
/>
