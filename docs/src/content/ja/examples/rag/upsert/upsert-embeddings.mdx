...
<Tabs items={['PgVector', 'Pinecone', 'Qdrant', 'Chroma', 'Astra DB', 'LibSQL', 'Upstash', 'Cloudflare', 'MongoDB']}>
  ...
  <Tabs.Tab>
    ...
    <GithubLink link={'https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/insert-embedding-in-pinecone'} />
  ...
  <Tabs.Tab>
    ...
    <GithubLink link={'https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/insert-embedding-in-chroma'} />
  ...
  <Tabs.Tab>
    ...
    <GithubLink link={'https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/rag/insert-embedding-in-libsql'} />
