...
```typescript filename="src/@@mastra/cli/cli/cli/agents/index.ts"
...
```typescript filename="src/@@mastra/cli/cli/cli/index.ts"
...
import { playAudio, Recorder } from "@mastra/cli/cli/cli/node-audio";
...
async function processTurn(
  ...
  const agent = @@mastra/cli/cli/cli.getAgent(agentName);
...
const @@mastra/cli/cli/cliClient = new MastraClient({
...
export default function DebateInterface() {
  ...
  const startDebate = async () => {
    ...
    try {
      const optimist = @@mastra/cli/cli/cliClient.getAgent("optimistAgent");
      const skeptic = @@mastra/cli/cli/cliClient.getAgent("skepticAgent");
  ...
  const playAudio = async (text: string, agent: string) => {
    ...
    try {
      setIsPlaying(true);
      const agentClient = @@mastra/cli/cli/cliClient.getAgent(
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/voice-examples/tree/main/text-to-speech/turn-taking"
  }
/>
