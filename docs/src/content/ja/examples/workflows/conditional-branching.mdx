...
async function runWorkflow(inputValue: number) {
  const workflow = @@mastra/cli/cli/cli.getWorkflow("conditionalWorkflow");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/workflows/conditional-branching"
  }
/>
