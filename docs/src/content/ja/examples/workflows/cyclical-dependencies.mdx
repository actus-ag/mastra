...
import { Workflow, Step } from "@mastra/cli/cli/cli/core";
import { z } from "zod";
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/workflows/workflow-with-cyclical-deps"
  }
/>
