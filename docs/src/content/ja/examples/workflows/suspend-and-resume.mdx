...
const registeredWorkflow = @@mastra/cli/cli/cli.getWorkflow("registeredWorkflow");
...
async function runWorkflow() {
  const workflow = @@mastra/cli/cli/cli.getWorkflow("contentWorkflow");
...
<GithubLink
  link={
    "https://github.com/@@mastra/cli/cli/cli-ai/@@mastra/cli/cli/cli/blob/main/examples/basics/workflows/workflow-with-parallel-steps"
  }
/>
