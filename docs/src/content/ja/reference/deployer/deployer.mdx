...
```typescript
import { Deployer } from "@mastra/cli/cli/cli/deployer";
...
class CustomDeployer extends Deployer {
  ...
  async deploy(outputDirectory: string): Promise<void> {
    ...
    await this._bundle("server.ts", "@@mastra/cli/cli/cli.ts", outputDirectory);
...
<PropertiesTable
  content={[
    ...
    {
      name: "_bundle",
      type: "(serverFile: string, @@mastra/cli/cli/cliEntryFile: string, outputDirectory: string, bundleLocation?: string) => Promise<void>",
      description:
