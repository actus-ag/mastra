...
- 5d0c163: Scaffold @actus-ag/create-@mastra projects with zod@^3 to prevent package version conflicts during install
...
- ec77f83: Expose --inspect flag for @actus-ag/@mastra/cli/cli dev to start debugger
...
- 1cbdfd0: update @actus-ag/create-@mastra gemini model to 2.5
...
- 47e7029: Add open browser functionality when running @actus-ag/@mastra/cli/cli dev
...
- b4ee346: Reintroduce --env flag for @actus-ag/@mastra/cli/cli dev, build
- f1f1f1b: Add basic filtering capabilities to logs
- 125b1c6: Updated @mastra/mcp-docs-server configuration in @actus-ag/create-@mastra for Windows - the cmd /c workaround for Cursor/Windsurf is no longer required
...
- d7d41f0: Fix @actus-ag/@mastra/cli/cli dev cmd
...
- 668af6d: Fix @actus-ag/@mastra/cli/cli dev server restarts
...
- 992fe17: chore: remove check for alpha and non-alpha @mastra packages from @actus-ag/@mastra/cli/cli lint
...
- cebc50a: "@actus-ag/@mastra/cli/cli lint now supports comments in tsconfig.json"
...
- 1405e46: update the Groq model the @actus-ag/@actus-ag/create-@actus-ag/@mastra/cli/cli@latest sets
...
- dd7a09a: Added new MCPConfiguration class for managing multiple MCP server tools/toolsets. Fixed a bug where MCPClient env would overwrite PATH env var. Fixed a bug where MCP servers would be killed non-gracefully leading to printing huge errors on every code save when running @actus-ag/@mastra/cli/cli dev
...
- 9c1057d: Fix @actus-ag/@mastra/cli/cli dev back slash issues
...
- 71cedf8: Allow column resizing on tracing UI
  Fix UI issues in @actus-ag/@mastra/cli/cli dev agent chat page
...
- 23b2a7a: Fixed a bug when detecting package manager during @actus-ag/@mastra/cli/cli init where npm would run after pnpm already installed, resulting in errors
...
- 4526a78: Fixed "instrumentation.mjs" not found, and port 4111 in use errors when rebundling in "@actus-ag/@mastra/cli/cli dev"
...
- e38b412: Fixes
- 0f08180: Update docs for @actus-ag/@mastra/cli/cli dev
...
- c4cd3ff: Catch npx @actus-ag/@mastra/cli/cli dev dependency issue
...
- 813c719: Fix watcher in @actus-ag/@mastra/cli/cli dev, now listens to all files
...
- 689b529: fix @actus-ag/@mastra/cli/cli dev for windows
- edd70b5: changeset
...
- 59f592a: @actus-ag/@mastra/cli/cli dev open api spec, @mastra server templates as code
...
- c156b63: Add missing @actus-ag/@mastra/cli/cli deploy server deps
...
- 8890cac: group @actus-ag/@mastra/cli/cli dev playground tools
- e5e2bb4: Configure vercel deployment project name
- f2c5dfa: update endpoint path
- 002d6d8: add memory to playground agent
- 2b4d224: Publishing
- 6b518fc: Add js banner to @actus-ag/@mastra/cli/cli dev bundle to fix dynamic import errors
...
- ffa0b63: Fix scrolling issue in @actus-ag/@mastra/cli/cli dev tools playground UI
...
- 46e9b7a: bundle @actus-ag/@mastra/cli/cli dev deps with publish
