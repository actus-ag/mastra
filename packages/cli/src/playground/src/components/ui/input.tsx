...
const inputVariants = cva(
  'flex w-full text-@@mastra/cli/cli/cli-el-6 rounded-sm border bg-transparent shadow-sm focus-visible:ring-ring transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'border-@@mastra/cli/cli/cli-border-1 border-border-1 placeholder:text-muted-foreground',
