...
- 7848663: Fixed an error in the @actus-ag/mastra-mcp alpha release where client.setLoggingLevel led to errors in clients that don't support it
...
- 8468b7f: @actus-ag/mastra-mcp tsup bundling
