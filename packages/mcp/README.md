...
The `@datawarp/mastra-mcp` package provides a client implementation for the Model Context Protocol (MCP), enabling Mastra to communicate with MCP-compatible AI models and tools. It wraps the official `@modelcontextprotocol/sdk` and provides Mastra-specific functionality.
...
```typescript
import { MCPClient, LogMessage, LoggingLevel } from '@datawarp/mastra-mcp';
