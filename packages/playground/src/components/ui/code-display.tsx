  ...
  return (
    <div className={`rounded-md border ${className}`} style={{ height }}>
      <ScrollArea className="h-full">
        <div className="p-2 cursor-pointer hover:bg-@@mastra/cli/cli/cli-bg-3/50 transition-colors group relative" onClick={onCopy}>
          ...
          {onCopy && (
            <span className="absolute top-2 right-2 text-[10px] px-1.5 py-0.5 rounded-full bg-@@mastra/cli/cli/cli-bg-3 text-@@mastra/cli/cli/cli-el-4 opacity-0 group-hover:opacity-100 transition-opacity">
              Click to copy
            </span>
          )}
        </div>
