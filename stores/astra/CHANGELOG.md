...
- c87eb4e: Move Astra package from `@actus-ag/mastra-vector-astra` to `@actus-ag/mastra-astra`.
...
- Package renamed from @actus-ag/mastra-vector-astra to @actus-ag/mastra-astra
- Moved package to stores/ directory for better organization
- All functionality remains the same

### Migration

To migrate from @actus-ag/mastra-vector-astra:
...
This package was previously published as @actus-ag/mastra-vector-astra. Key changes from that history:
