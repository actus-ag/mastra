...
- c87eb4e: Move Astra package from `@datawarp/mastra-vector-astra` to `@datawarp/mastra-astra`.
...
- Package renamed from @datawarp/mastra-vector-astra to @datawarp/mastra-astra
- Moved package to stores/ directory for better organization
- All functionality remains the same

### Migration

To migrate from @datawarp/mastra-vector-astra:

1. Remove @datawarp/mastra-vector-astra from dependencies
2. Install @datawarp/mastra-astra
3. Update imports from '@datawarp/mastra-vector-astra' to '@datawarp/mastra-astra'

### Previous History

This package was previously published as @datawarp/mastra-vector-astra. Key changes from that history:
