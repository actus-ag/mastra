...
- 684d5d1: Move Chroma package from `@datawarp/mastra-vector-chroma` to `@datawarp/mastra-chroma`.
...
- Package renamed from @datawarp/mastra-vector-chroma to @datawarp/mastra-chroma
- Moved package to stores/ directory for better organization
- All functionality remains the same

### Migration

To migrate from @datawarp/mastra-vector-chroma:

1. Remove @datawarp/mastra-vector-chroma from dependencies
2. Install @datawarp/mastra-chroma
3. Update imports from '@datawarp/mastra-vector-chroma' to '@datawarp/mastra-chroma'

### Previous History

This package was previously published as @datawarp/mastra-vector-chroma. Key changes from that history:
