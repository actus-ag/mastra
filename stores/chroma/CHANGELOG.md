...
- 684d5d1: Move Chroma package from `@actus-ag/mastra-vector-chroma` to `@actus-ag/mastra-chroma`.
...
- Package renamed from @actus-ag/mastra-vector-chroma to @actus-ag/mastra-chroma
- Moved package to stores/ directory for better organization
- All functionality remains the same

### Migration

To migrate from @actus-ag/mastra-vector-chroma:

1. Remove @actus-ag/mastra-vector-chroma from dependencies
2. Install @actus-ag/mastra-chroma
3. Update imports from '@actus-ag/mastra-vector-chroma' to '@actus-ag/mastra-chroma'

### Previous History

This package was previously published as @actus-ag/mastra-vector-chroma. Key changes from that history:
