...
```bash
pnpm add @datawarp/mastra-lance @lancedb/lancedb apache-arrow
```
...
```typescript
import { LanceStorage } from '@datawarp/mastra-lance';
...
```typescript
import { TABLE_MESSAGES } from '@datawarp/mastra-core/storage';
import type { StorageColumn } from '@datawarp/mastra-core/storage';
...
```typescript
import type { StorageThreadType } from '@datawarp/mastra-core';
...
```typescript
import type { MessageType } from '@datawarp/mastra-core';
...
const messages: MessageType[] = [
  ...
  },
  {
    ...
    resourceId: 'resource-123',
    role: 'assistant',
    content: 'You can use LanceDB with Mastra by installing @datawarp/mastra-lance package.',
    createdAt: new Date(),
    type: 'text',
    toolCallIds: [],
    toolCallArgs: [],
