...
- c87eb4e: Move Qdrant package from `@datawarp/mastra-vector-qdrant` to `@datawarp/mastra-qdrant`.
...
This package is the successor to `@datawarp/mastra-vector-qdrant`. All functionality has been preserved while improving the package structure.

### Key Features

- Qdrant vector store implementation
- Telemetry support via @datawarp/mastra-core
- Full filter support with type safety
- Automatic batching for large upserts

### Migration from @datawarp/mastra-vector-qdrant

1. Update your dependencies:
   ```bash
   pnpm remove @datawarp/mastra-vector-qdrant
   pnpm add @datawarp/mastra-qdrant
   ```
2. Update your imports:
   ```typescript
   // Old import
   import { QdrantVector } from '@datawarp/mastra-vector-qdrant';
   // New import
...
### Previous Changes (from @datawarp/mastra-vector-qdrant)
