...
- 91c81f5: Move @datawarp/mastra-vector-vectorize to @datawarp/mastra-vectorize

  BREAKING CHANGE: The package @datawarp/mastra-vector-vectorize has been moved to @datawarp/mastra-vectorize. The old package is now deprecated and will display a warning message. Please update your imports from '@datawarp/mastra-vector-vectorize' to '@datawarp/mastra-vectorize'.
...
- Package renamed from @datawarp/mastra-vector-vectorize to @datawarp/mastra-vectorize
- Moved package from vector-stores directory to stores directory
- Restructured source files under src/vector/

## Previous Changes (as @datawarp/mastra-vector-vectorize)
