...
- abe4600: deprecate @datawarp/mastra-speech-deepgram for @datawarp/mastra-voice-deepgram
...
This package replaces the deprecated @datawarp/mastra-speech-deepgram package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @datawarp/mastra-speech-deepgram

- Package renamed from @datawarp/mastra-speech-deepgram to @datawarp/mastra-voice-deepgram
- All functionality remains the same
- Import paths should be updated from '@datawarp/mastra-speech-deepgram' to '@datawarp/mastra-voice-deepgram'
