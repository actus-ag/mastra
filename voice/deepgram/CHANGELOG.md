...
- abe4600: deprecate @actus-ag/mastra-speech-deepgram for @actus-ag/mastra-voice-deepgram
...
This package replaces the deprecated @actus-ag/mastra-speech-deepgram package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @actus-ag/mastra-speech-deepgram

- Package renamed from @actus-ag/mastra-speech-deepgram to @actus-ag/mastra-voice-deepgram
- All functionality remains the same
- Import paths should be updated from '@actus-ag/mastra-speech-deepgram' to '@actus-ag/mastra-voice-deepgram'
