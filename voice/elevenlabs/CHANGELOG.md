...
- f626fbb: deprecate @datawarp/mastra-speech-deepgram for @datawarp/mastra-voice-deepgram
...
This package replaces the deprecated @datawarp/mastra-speech-elevenlabs package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @datawarp/mastra-speech-elevenlabs

- Package renamed from @datawarp/mastra-speech-elevenlabs to @datawarp/mastra-voice-elevenlabs
- API changes:
...
- Import paths should be updated from '@datawarp/mastra-speech-elevenlabs' to '@datawarp/mastra-voice-elevenlabs'
