# @actus-ag/mastra-voice-elevenlabs
...
- f626fbb: deprecate @actus-ag/mastra-speech-deepgram for @actus-ag/mastra-voice-deepgram
...
This package replaces the deprecated @actus-ag/mastra-speech-elevenlabs package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @actus-ag/mastra-speech-elevenlabs

- Package renamed from @actus-ag/mastra-speech-elevenlabs to @actus-ag/mastra-voice-elevenlabs
- API changes:
...
- Import paths should be updated from '@actus-ag/mastra-speech-elevenlabs' to '@actus-ag/mastra-voice-elevenlabs'
