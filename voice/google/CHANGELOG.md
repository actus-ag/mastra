...
- 5e0f727: deprecate @datawarp/mastra-speech-google for @datawarp/mastra-voice-google
...
- Initial release of @datawarp/mastra-voice-google
- Combines functionality from deprecated @datawarp/mastra-speech-google
- Adds Speech-to-Text capabilities
- Implements new MastraVoice interface from @datawarp/mastra-core

### Notes

This package replaces @datawarp/mastra-speech-google, which reached version 0.1.3-alpha.1. Key features from the previous package:
