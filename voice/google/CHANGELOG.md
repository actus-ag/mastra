...
- 5e0f727: deprecate @actus-ag/mastra-speech-google for @actus-ag/mastra-voice-google
...
- Initial release of @actus-ag/mastra-voice-google
- Combines functionality from deprecated @actus-ag/mastra-speech-google
- Adds Speech-to-Text capabilities
- Implements new MastraVoice interface from @actus-ag/mastra-core

### Notes

This package replaces @actus-ag/mastra-speech-google, which reached version 0.1.3-alpha.1. Key features from the previous package:
