...
- 5b1af96: deprecate @datawarp/mastra-speech-murf for @datawarp/mastra-voice-murf
...
This package replaces the deprecated @datawarp/mastra-speech-murf package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @datawarp/mastra-speech-murf

- Package renamed from @datawarp/mastra-speech-murf to @datawarp/mastra-voice-murf
- API changes:
...
- Import paths should be updated from '@datawarp/mastra-speech-murf' to '@datawarp/mastra-voice-murf'
