...
- 0821d6b: Deprecate @datawarp/mastra-speech-openai for @datawarp/mastra-voice-openai
...
- `@datawarp/mastra-speech-openai` is now deprecated. Please use `@datawarp/mastra-voice-openai` instead.
