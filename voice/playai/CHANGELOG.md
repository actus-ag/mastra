...
- 41d0166: deprecate @actus-ag/mastra-speech-playai for @actus-ag/mastra-voice-playai
...
This package replaces the deprecated @actus-ag/mastra-speech-playai package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @actus-ag/mastra-speech-playai

- Package renamed from @actus-ag/mastra-speech-playai to @actus-ag/mastra-voice-playai
- API changes:
...
- Import paths should be updated from '@actus-ag/mastra-speech-playai' to '@actus-ag/mastra-voice-playai'
