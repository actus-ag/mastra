...
- 41d0166: deprecate @datawarp/mastra-speech-playai for @datawarp/mastra-voice-playai
...
This package replaces the deprecated @datawarp/mastra-speech-playai package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @datawarp/mastra-speech-playai

- Package renamed from @datawarp/mastra-speech-playai to @datawarp/mastra-voice-playai
- API changes:
...
- Import paths should be updated from '@datawarp/mastra-speech-playai' to '@datawarp/mastra-voice-playai'
