...
- f477df7: deprecate @actus-ag/mastra-speech-speechify for @actus-ag/mastra-voice-speechify
...
This package replaces the deprecated @actus-ag/mastra-speech-speechify package. All functionality has been migrated to this new package with a more consistent naming scheme.

### Changes from @actus-ag/mastra-speech-speechify

- Package renamed from @actus-ag/mastra-speech-speechify to @actus-ag/mastra-voice-speechify
- API changes:
...
- Import paths should be updated from '@actus-ag/mastra-speech-speechify' to '@actus-ag/mastra-voice-speechify'
